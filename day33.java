...
public class day33 {
    public static void main(String[] args) {
        ...
        System.out.print("Masukkan level keamanan (1 - 10): ");
        int level = sc.nextInt();

        System.out.print("Masukkan jumlah misi sukses: ");
        int misi = sc.nextInt();

        System.out.print("Apakah Anda terdeteksi oleh musuh? (true/false): ");
        ...
        // hasil
        System.out.println("\n--- HASIL VERIFIKASI ---");
        System.out.println("Level cukup? " + levelCukup);
        System.out.println("Pengalaman cukup? " + pengalaman);
